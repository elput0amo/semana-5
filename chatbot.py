...
while (bucle):
    ...
    accion= input  (f"Porfavor escribe la accion que quieras realizar, (depositar, extraer, comprobar dinero, cambiar divisa, cometer suicidio economico, cerrar sesion): ")
...
#sacar pasta
        ...
        print(f"Gracias por utilizar nuestros servicios, hemos vendido todos tus derechos ")
        bucle = False
