...
accion= input  (f"Porfavor escribe la accion que quieras realizar, (depositar, extraer, comprobar dinero, cambiar divisa, cometer suicidio economico): ")
...
#sacar pasta
    ...
    print(f"Te lo digo cada vez que haces algo, esta opcion solo esta para hacer parecer que el chatbot tiene varias opciones")
    print(f"Unpopular opinion, la gente de marketing y politica son seres humanos solo por el maspequeño de los vacios legales")
